...
const sidebarItems = {
  'Getting Started': [
    ...
    { href: '/docs/getting-started', label: 'Sync vs Async', sectionId: 'sync-vs-async' },
    { href: '/docs/getting-started', label: 'System Requirements', sectionId: 'requirements' },
    { href: '/docs/getting-started', label: 'Your First Request', sectionId: 'first-request' },
  ...
  'Core API': [
    ...
    { href: '/docs/core-api', label: 'Response Object', sectionId: 'response-handling' },
    { href: '/docs/core-api', label: 'Client Configuration', sectionId: 'configuration' },
    { href: '/docs/core-api', label: 'Headers & Params', sectionId: 'headers-params' },
    { href: '/docs/core-api', label: 'Response Types', sectionId: 'response-types' },
    { href: '/docs/core-api', label: 'Error Handling', sectionId: 'error-handling' },
  ],
  'Advanced Features': [
    { href: '/docs/advanced', label: 'Interceptors & Hooks', sectionId: 'interceptors' },
    { href: '/docs/advanced', label: 'Cancellation', sectionId: 'cancellation' },
    { href: '/docs/advanced', label: 'Multithreading & Concurrency', sectionId: 'concurrency' },
    { href: '/docs/advanced', label: 'Streaming, Download & Pagination', sectionId: 'streaming' },
    { href: '/docs/advanced', label: 'FormData & File Uploads', sectionId: 'formdata' },
    { href: '/docs/advanced', label: 'Caching', sectionId: 'caching' },
    { href: '/docs/advanced', label: 'Cookies & XSRF', sectionId: 'cookies' },
    { href: '/docs/advanced', label: 'Authentication', sectionId: 'auth' },
    { href: '/docs/advanced', label: 'Proxies, TLS & Unix Sockets', sectionId: 'networking' },
    { href: '/docs/advanced', label: 'Retries & Backoff', sectionId: 'retries' },
  ],
  Reference: [
    ...
    { href: '/docs/reference', label: 'RequestConfig Fields', sectionId: 'config-reference' },
    ...
    { href: '/docs/reference', label: 'Migrating from v1', sectionId: 'migration' },
  ],
}
